const avatar = require('../assets/images/app_images/avatar.png')
const robustaSquare = require('../assets/coffee_assets/robusta_coffee_beans/robusta_coffee_beans_square.png')
const robustaPortrait = require('../assets/coffee_assets/robusta_coffee_beans/robusta_coffee_beans_portrait.png')
const arabicaSquare = require('../assets/coffee_assets/arabica_coffee_beans/arabica_coffee_beans_square.png')
const arabicaPortrait = require('../assets/coffee_assets/arabica_coffee_beans/arabica_coffee_beans_portrait.png')
const libericaSquare = require('../assets/coffee_assets/liberica_coffee_beans/liberica_coffee_beans_square.png')
const libericaPortrait = require('../assets/coffee_assets/liberica_coffee_beans/liberica_coffee_beans_portrait.png')
const excelsaSquare = require('../assets/coffee_assets/excelsa_coffee_beans/excelsa_coffee_beans_square.png')
const excelsaPortrait = require('../assets/coffee_assets/excelsa_coffee_beans/excelsa_coffee_beans_portrait.png')

const americanoSquare = require('../assets/coffee_assets/americano/square/americano_pic_1_square.png')
const americanoPortrait = require('../assets/coffee_assets/americano/portrait/americano_pic_2_portrait.png')
const americano1Square = require('../assets/coffee_assets/americano/square/americano_pic_2_square.png')
const americano1Portrait = require('../assets/coffee_assets/americano/portrait/americano_pic_2_portrait.png')
const americano2Square = require('../assets/coffee_assets/americano/square/americano_pic_3_square.png')
const americano2Portrait = require('../assets/coffee_assets/americano/portrait/americano_pic_3_portrait.png')
...
export const CoffeeData = [
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: americanoSquare,
    imagelink_portrait: americanoPortrait,
    ingredients: 'Milk',
  ...
  },
  {
    ...
    description: `The Americano is another popular type of coffee drink, and it's very easy to make! It's just espresso with hot water dripping over it. The name came about during World War II when European baristas added water to their espresso drinks for the American soldiers stationed there. The resulting drink had a smoother, less concentrated flavour than espresso and thus the Americano was born.`,
    roasted: 'Medium Roasted',
    imagelink_square: americano1Square,
    imagelink_portrait: americano1Portrait,
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
  ...
  },
  {
    ...
    description: `The Americano is another popular type of coffee drink, and it's very easy to make! It's just espresso with hot water dripping over it. The name came about during World War II when European baristas added water to their espresso drinks for the American soldiers stationed there. The resulting drink had a smoother, less concentrated flavour than espresso and thus the Americano was born.`,
    roasted: 'Medium Roasted',
    imagelink_square: americano2Square,
    imagelink_portrait: americano2Portrait,
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      {size: 'S', price: '1.38', currency: '$'},
